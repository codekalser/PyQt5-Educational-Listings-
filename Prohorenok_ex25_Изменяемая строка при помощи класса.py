class MutableString:
    ...
    #Добавим функциональность от итератора
    def __iter__(self):
        self.__i = 0
        return self
    def __next__(self):
    ...
    #Определим вспомогательный метод, который будет
    #проверять корректность индекса
    ...
    #добавим функциональность контейнера-списка
